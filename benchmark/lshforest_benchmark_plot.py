...
from lsh_benchmark_plot import get_precision_recall
...
if __name__ == "__main__":
    ...
    axes[0].plot(num_perms, lsh_precisions, marker="+", label="LSH Forest")
    ...
    axes[1].plot(num_perms, lsh_recalls, marker="+", label="LSH Forest")
    ...
    axes[2].plot(num_perms, lsh_times, marker="+", label="LSH Forest")
